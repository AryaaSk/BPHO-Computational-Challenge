...
const Challenge3 = () => {
    ...
    const slider = document.getElementById("launch_speed");
...
//     const g = Challenge356Parameters.g;
//     const X = Challenge356Parameters.x;
//     const Y = Challenge356Parameters.y;
//     const u = Challenge356Parameters.launch_speed;
//     const h = Challenge356Parameters.h;
//     const Y_min = Y - h; // set coord system such that h = 0
//     // minimum speed to launch projectile
//     const min_speed = Math.sqrt(g) * Math.sqrt(Y_min + Math.sqrt(Y_min ** 2 + X ** 2));
//     // calculate the values for theta
...
//      // angle if projectile launched at minimum speed
//      const tan_theta_min = (Y_min + Math.sqrt(X ** 2 + Y_min ** 2)) / X;
//      const theta_min = Math.atan(tan_theta_min);
//     let tan_theta_low = tan_theta_min;
//     let tan_theta_high = tan_theta_min;
//     let theta_low = theta_min;
//     let theta_high = theta_min;
//     if (solutions.length === 2) {
//         tan_theta_low = solutions[0];
//         tan_theta_high = solutions[1];
//         theta_low = Math.atan(tan_theta_low);
//         theta_high = Math.atan(tan_theta_high);
//     }
//     // returns y values for projectile
...
//             points_low.push([x_low, y(x_low, tan_theta_low, u)]);
//         }
//         for (let x_high = 0; x_high <= X; x_high += X / 100) {
//             points_high.push([x_high, y(x_high, tan_theta_high, u)]);
//         }
//     }
//     // only need to keep target x and y in view
//     canvas.CalculateConversionFactors();
...
//     AddLabel("range_high");
//     AddLabel("range_low")
//     AddLabel("distanceTravelled");
//     UpdateLabelText("distanceTravelled", "Distance Travelled: Xm", 5);
//     UpdateLabelText("range_low", "Range low: Xm", R(theta_low));
//     UpdateLabelText("range_high", "Range high: Xm", R(theta_high));
//     UpdateLabelText("range_min", "Range min: Xm", R(theta_min));
// }
InitChallengeToggle([
