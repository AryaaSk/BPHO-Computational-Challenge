...
function RotateAroundXAxis(vector, angle) {
...
function RotateAroundYAxis(vector, angle) {
    const cosTheta = Math.cos(angle);
    const sinTheta = Math.sin(angle);
...
function RotateAroundZAxis(vector, angle) {
    const cosTheta = Math.cos(angle);
    const sinTheta = Math.sin(angle);
...
function CartesianToSpherical(cartesian, r) {
