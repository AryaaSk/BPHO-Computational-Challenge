...
InitSliderForKey(Challenge356Parameters, "g", "Gravitaional Field Strength (X ms-2)", { min: 1, max: 15, step: 0.1 });
InitSliderForKey(Challenge356Parameters, "u", "Launch Speed (X ms-1)", { min: 0, max: 500, step: 0.1 });
...
const Challenge3 = () => {
    ...
    const launch_speed = Challenge356Parameters.u;
...
InitChallengeToggle([
    ...
    { buttonID: "challenge6", challengeCallback: Challenge6 },
]);
